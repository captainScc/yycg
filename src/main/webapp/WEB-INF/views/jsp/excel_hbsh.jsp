    ...
    <style>
        *{
        ...
        .title-l{
            ...
            margin-top:24.5px;
            background:url(${pageContext.request.contextPath }/images/logo/hbsh.png) no-repeat;
        ...
        <c:if test="${totalPage <= 10}">
            <c:forEach begin="1" end="${totalPage}" step="1" var="i">
                <c:if test="${pageIndex == i}">
                    <a style="background:#455376;color:#fff" href="${pageContext.request.contextPath }/selectData.do?pageIndex=${i}&startTime=${startTime}&endTime=${endTime}&name=${name}">${i}</a>
                </c:if>
                <c:if test="${pageIndex != i}">
