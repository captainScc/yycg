...
<header>
    <div class="title"></div>
    <div class="title-l">北京视游互动科技有限公司</div>
</header>
<div class="container">
    <div style="height: 74px;background: #007DDB;">
        ...
        <form id="selectForm" action="${pageContext.request.contextPath }/selectData.do" method="post">
            ...
            <div class="layui-form" style="width:400px;float: left">
                <div class="layui-form-item" style="margin-bottom: 0;">
                    ...
                    <div class="layui-inline" style="width:30%">
                        <input id="startTime" style="width:100%;background: #007DDB" type="text" name="startTime" class="layui-input test-item" value="${startTime}">
                    </div>
                    结束日期:
                    <div class="layui-inline" style="width:30%">
                        <input id="endTime" style="width:100%;background: #007DDB" type="text" name="endTime" class="layui-input test-item" value="${endTime}">
                    </div>
                </div>
            </div>
            ...
            名称:
            <select id="cpmc" name="name" style="width: 150px;background: #007DDB;color:#fff">
