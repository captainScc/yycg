        ...
        <div class="layui-form" style="width:400px;float: left">
            <div class="layui-form-item" style="margin-bottom: 0;">
                ...
                <div class="layui-inline" style="width:30%">
                    <input id="startTime" style="width:100%" type="text" name="startTime" class="layui-input test-item" placeholder="yyyy-MM-dd" value="${startTime}">
                </div>
                    结束日期:
                <div class="layui-inline" style="width:30%">
                    <input id="endTime" style="width:100%" type="text" name="endTime" class="layui-input test-item" placeholder="yyyy-MM-dd" value="${endTime}">
                </div>
            </div>
        </div>
